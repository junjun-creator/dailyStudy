...
<body>
            ...
            <div class="section_visual">
                <div class="group_visual">
                    <div class="container_visual">
                        ...
                        <div>
                            <div class="container_visual">
                                <!-- 자동 슬라이드는 구현, but 이전 다음 버튼 클릭시 작동은 미구현. -->
                                <ul class="visual_img">
                                	<c:forEach items="${list}" var = "promotionfile">
                                		<img style="width:207px; height:200px;" src="${pageContext.request.contextPath}/img/${promotionfile.fileName}">
                                	</c:forEach>
                                </ul>
                            </div>
    ...
    <script>
		...
		//});
    	var slide_ul = document.querySelector(".visual_img");
    	var firstItemClone = slide_ul.firstElementChild.cloneNode(true);
    	var secondItemClone = slide_ul.firstElementChild.nextElementSibling.cloneNode(true);
    	slide_ul.appendChild(firstItemClone);
    	slide_ul.appendChild(secondItemClone);
		var btn_pre_e = document.querySelector(".prev_inn");
    	
    	function move(){
    		var currentIndex = 0;
    		
    		setInterval(function(){
    			slide_ul.style.transition = '0.2s';
    			slide_ul.style.transform = "translate3d(-"+207*(currentIndex+1)+"px, 0px, 0px)";
    			
    			currentIndex++;
    			
    			if(currentIndex === 11){
    				setTimeout(function(){
                        slide_ul.style.transition = '0s';
                        slide_ul.style.transform = "translate3d(0px, 0px, 0px)";
                    },201)
    				currentIndex = 0;
    			}
    		}, 2000);
