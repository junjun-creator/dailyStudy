...
public class ReservationDaoSqls {
	...
	//전체리스트 정보 및 사진이름 쿼리
	public static final String SELECT_ALL_ITEMS = "SELECT product.id, product.description, product.content, display_info.place_name FROM product JOIN display_info ON product.id=display_info.product_id limit :start, :limit";
