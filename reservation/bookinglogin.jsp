...
<html lang="ko" class="no-js" >
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/bookinglogin.css"/>
   </head>
   <body class="biz  ko" >
      ...
      <app>
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" method="post" class="ng-pristine ng-valid" id="form1" action="./myreservation">
         ...
         <translater-modal style="display: none;">
       	...
       	<script>
       		var input_email = document.querySelector('#resrv_id');
       		var btn = document.querySelector(".login_btn.confirm");
